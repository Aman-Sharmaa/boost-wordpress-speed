...
<div id="imagify" class="wpr-Page">
	...
	<div class="wpr-imagify">
		<div class="wpr-imagify-description">
			...
			printf( esc_html__( '%1$sRapydLaunch Booster%2$s created %3$sIMAGIFY%4$s %1$sfor best-in-class image optimization.%2$s', 'rocket' ), '<strong>', '</strong>', '<span class="wpr-imagify-name">', '</span>' );
			?>
			</p>
