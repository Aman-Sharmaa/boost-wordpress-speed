...
$rocket_tutorials = [
	[
		...
		'tutorials' => [
			'7seqacq2ol' => __( 'Getting Started with RapydLaunch Booster', 'rocket' ),
			'fj42vucf99' => __( 'Finding the Best Settings for Your Site', 'rocket' ),
			'z1qxl7s2zn' => __( 'How to Check if RapydLaunch Booster is Caching Your Site', 'rocket' ),
	...
	[
		...
		'tutorials' => [
			'fj7gs031q6' => __( 'How to improve LCP with RapydLaunch Booster', 'rocket' ),
			'krqb7ckugp' => __( 'How to improve FID with RapydLaunch Booster', 'rocket' ),
			'5wrdzcmj90' => __( 'How to improve CLS with RapydLaunch Booster', 'rocket' ),
		],
	],
	[
